// ejercicio 1
// Leer un carácter y deducir si está o no comprendido entre las letras 'a'... 'z' y 'A'...'Z' ambas inclusive y sino verificar si es un signo de puntuacion ", . ; :"
...
// proceso: respecto a la caracter ingresada por el usuario se determina si el carácter ingresado es una vocal y se obtiene su valor ASCII.
//          i el carácter es 'a', 'A', 'e', 'E', 'i', 'I', 'o', 'O', 'u', 'U'.
//          Se puede obtener y mostrar el valor ASCII del carácter.
//          De otro modo si el carácter no pertenece a ninguna de las vocales especificadas el caracter no es una vocal 
...
// proceso: respecto a la caracter ingresada por el usuario se compara los nombres para determinar si son iguales o cuál es mayor alfabéticamente.
...
// proceso: Se determina el mayor de los tres números o determine si son iguales 
...
// proceso: se determina si el signo del número es positivo, negativo o neutro
...
// proceso: Se calcula el costo total de los lápices según la cantidad ingresada ingresada por el usuario 
...
Funcion ejer11(0)
	...
	// costoAlumno = 95 SiNo costoAlumno = 400 pagoCompañia = costoAlumno * numAlumnos
	//Salida:"El pago a la compañía es: ", pagoCompañia
...
Funcion ejer19(0)
	...
	// Escribir "1.América del Norte"Escribir "2.América Central" 
	// Escribir "3.América del Sur"Escribir "4.Europa" Escribir "5.Asia" leer zona 
	// si zona =1 Entonces co= (pe*1000) *11 Escribir "1.América del Norte" SiNo Si zona = 2 Entonces co = (pe*1000)*10 
...
Funcion ejer29(0) 
	...
	Escribir "Ingrese el número de horas trabajadas por día durante los 20 días del mes:"
	Leer ht
...
Funcion ejer30(0)
	...
	Escribir "El número de ventas mayores a $1000 es: ", c1, " y el monto total es: $", m1, "."
	Escribir "El número de ventas mayores a $500 pero menores o iguales a $1000 es: ", c2, " y el monto total es: $", m2, "."
	Escribir "El número de ventas menores o iguales a $500 es: ", c3, " y el monto total es: $", m3, "."
